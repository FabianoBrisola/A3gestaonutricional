 ...
 * @author user
 */
public class Tela_hipercalorica extends javax.swing.JFrame {

    /**
     * Creates new form Tela_hipercalorica
     */
    public Tela_hipercalorica() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("   ");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 290, 460));
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 0, 360, 460));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_hipercalorica.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tela_hipercalorica().setVisible(true);
            }
        });
    }
